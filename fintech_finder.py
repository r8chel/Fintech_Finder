...
# The application calculates the candidate’s wage and allows the customer
# (you, in this case) to send an Ethereum blockchain transaction that pays the hired candidate. 
